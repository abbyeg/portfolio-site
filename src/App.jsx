...
const App = () => {
  ...
  content.set('howIBuiltThisSite', {
    ...
    cats: ["software", "web", "writing"],
    link: "/work/portfolio-project"
  });
  content.set('renderer', { id: uuidv4(), name: "Real Time 3D Renderer", sub: "Rust, OpenGL", previewImage: "/proj1/preview.gif", cats: ["software"], link: "https://github.com/abbyeg" });
  content.set('shaders', { id: uuidv4(), name: "Custom Shaders", sub: "GLSL", previewImage: "/proj1/preview.gif", cats: ["software"] });
  content.set('procedural',   { id: uuidv4(), name: "Procedural Content Generation Tool", sub: "CSS", previewImage: "/proj1/preview.gif", cats: ["software"] });
  content.set('artInstallation', { id: uuidv4(), name: "Interactive Art Installation", sub: "CSS", previewImage: "/proj1/preview.gif", cats: ["software"] });
  content.set('animationToolkit', { id: uuidv4(), name: "Rigging and Animation Toolkit", sub: "", previewImage: "/proj1/preview.gif", cats: ["software"] });
        ...
        <Routes>
          <Route path="/" element={<Layout />}>
            ...
            <Route path="work/portfolio-project" element={
              <BlogPost 
                post={content.get('howIBuiltThisSite')}
              />
            }
            />
